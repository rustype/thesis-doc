...
% CITE: Neykova (not yet on Mendeley)
The work by Neykova et al. \autocite{Neykova} leverages F\#'s type providers to provide developers with practical session types along with refinements.
...
\paragraph{Sesh}
The \texttt{sesh} crate \cite{Kokke2019}, in contrast to \texttt{session-types} (\autocite{Jespersen2015}),
