...
Regardless, when one views the list of features Ada has, the first arising question is \equotes{why is Ada not popular?}.
...
Go was not able to meet the expected performance requirements and the company replaced it with Rust\citeurl{https://blog.discord.com/why-discord-is-switching-from-go-to-rust-a190bbca2b1f}{08/06/2021}.
...
being the only one which does not suffer from the \equotes{billion dollar mistake}\citeurl{https://tinyurl.com/Hoare2009}{2021-01-25}.

\section{The Rust Language}\label{sec:rust-lang}

Rust is a fairly recent systems programming language,
it started as a side project of the author Graydon Hoare and the language public history dates back to 2010\citeurl{https://git.io/JZ3X7}{08/06/2021}.
...
First, \texttt{"Hello"} is assigned to \texttt{x}, thus \texttt{x} now owns \texttt{"Hello"}.
...
\paragraph{Obsidian} is a language targeting Hyperledger Fabric\citeurl{https://www.hyperledger.org/use/fabric}{08/06/2021},
