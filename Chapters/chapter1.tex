...
while reading a reply from the server, a client would get a \ttt{SocketTimeoutException}\citeurl{https://docs.oracle.com/javase/8/docs/api/java/net/SocketTimeoutException.html}{14/07/2021},
...
thus causing the \gls{JVM} to crash with an \ttt{OutOfMemoryException}\citeurl{https://docs.oracle.com/javase/8/docs/technotes/guides/troubleshoot/memleaks002.html}{14/07/2021}.
...
% TODO add citation for Honda1993
...
% TODO add citation for Strom1986
