...
each analyzing a different part of the code. % TODO: AST should probably Concrete Syntax Tree
...
to avoid this problem \texttt{typestate} declares an additional, undocumented and inert\ie{a macro that returns its input}, macro;
...
\begin{figure}
    ...
    \caption[test]{ % HACK
        ...
        the macro depends only on \texttt{typestate-deps}\footnotemark and does not export any dependency.
    }
