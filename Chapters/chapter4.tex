...
\paragraph{The \annotation{typestate} annotation} is the DSL's entrypoint and
...
This alone is not enough, as the macro will throw an error due to the lack of an automaton, shown in \autoref{lst:vending-machine-typestate-missing-automaton}.
...
\label{lst:vending-machine-typestate-missing-automaton}
\end{listing}
