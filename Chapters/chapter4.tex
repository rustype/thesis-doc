...
a structure annotated with \annotation{automaton} (of which there can only be one),
one annotated with \annotation{state} (of which there can be $N$)
...
which later gets processed by Rust's macro system and the annotation is naturally removed. % TODO: "naturally" has tones of "obviously", which is not the tone I am going for
